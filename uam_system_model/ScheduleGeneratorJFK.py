...
from .utils.schedule_utils import (build_schedules,
...
class ScheduleGenerator:
    ...
    def get_one_day(
        ...
        paxArrivalDf = pd.DataFrame(columns=['passenger_arrival_time_s', 'origin_vertiport_id', 'destination_vertiport_id'])
        ...
        for od in list_of_ods:
            ...
            departure_time, num_pax = build_schedules(arrival_time, max_waiting_time=max_waiting_time, occupancy=occupancy)
            ...
            schedule = pd.concat([
                ...
                pd.DataFrame({
                    ...
                    'od': od,
                    'num_pax': num_pax,
                    'revenue': num_pax * flight_distance_matrix[vertiport_dict[od.split('_')[0]], vertiport_dict[od.split('_')[1]]] * fare # assume flat fare of $50
                })
            ], ignore_index=True)
            ...
            paxArrivalDf = pd.concat([
                ...
                pd.DataFrame({
                    ...
                    'destination_vertiport_id': vertiport_dict[od.split('_')[1]],
                })
            ], ignore_index=True)
